"""Generate progress timeline plots for clax development talk."""
...
ax.set_title(r"clax: from first commit to sub-percent $C_\ell$ in one weekend",
...
plt.savefig("scripts/clax_progress.pdf", bbox_inches="tight", dpi=150)
plt.savefig("scripts/clax_progress.png", bbox_inches="tight", dpi=200)
print("Saved to scripts/clax_progress.pdf and .png")
