"""Test n_k_fine convergence for C_l k-integration."""
import sys
sys.path.insert(0, '.')
import numpy as np
import jax
...
ell_ref = ref_cls['ell']
ells = [100, 300, 500, 700, 1000, 1500]
...
# Test n_k_fine convergence
for n_fine in [3000, 5000, 10000, 20000]:
    ...
    for i, ell in enumerate(ells):
        ...
        print(f"  {ell:6d} {tt_err:+10.3f}{mark} {ee_err:+10.3f}")
